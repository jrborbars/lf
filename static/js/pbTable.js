...
(function($){
	$.fn.pbTable = function(options_user){
		var options_default = {
			...
			sortable:true,
			isMobile:true,
			msgSinDatos:'Não foram encontrados resultados para a sua pesquisa.',
			toolbar:{
					enabled:true,
					idToAppend:'filterbox',
					filterBox:true,
		...
		var txtSearchBox = '<input id="search-' + myTable.attr('id') + '" search-in="' + myTable.attr('id') + '" type="search" class="form-control" placeholder="Buscar...">',
			...
			divContainer +=	'<div name="sectionForSearchBox" class="col-xs-12 col-md-6 col-lg-4" style="padding-right:0px;">';
